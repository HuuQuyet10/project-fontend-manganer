              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers
                    ...
                    .map((row) => {
                      const { id, name, house, status, email, avatarUrl, diocese, mobile, s } = row;
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left">{diocese}</TableCell>
